...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/get/friends/**").authenticated()
				.antMatchers(HttpMethod.POST, "/add/friend").authenticated()
				.antMatchers(HttpMethod.GET, "/getMessage/**/**").authenticated()
				.antMatchers(HttpMethod.GET, "/find/friend/**").authenticated()
                .and()
                .sessionManagement()
